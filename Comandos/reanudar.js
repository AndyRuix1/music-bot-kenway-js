...
module.exports = new discord_kenway_handler_1.Comando({
    nombre: 'reanudar',
    descripcion: 'Reanuda una reproducción en pausa.',
    ejecutar: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!listener.playingNow.isPaused)
            return interaction.reply({ embeds: [{ title: `${Helpers_1.emojis.redCircle} | NO PAUSADO`, description: `La reproducción actual no se encuentra en pausa. Para pausar la reproducción, utiliza el comando 'pausar'`, color: 'RED' }] });
